...
// These functions are ignored because they have generic arguments: `get_current_version`, `watch_changes_since`
...
// These functions are ignored (category: IgnoreBecauseExplicitAttribute): `from_current_span`, `from_json`, `from_span_context`, `is_local`, `local_with_current_span`, `operation_id`, `remote_with_current_span`, `to_batch_trace_context`, `to_json`, `to_span_context`, `trace_id`
...
class BatchTraceContext {
  ...
  Future<bool> isSampled() => RustLib.instance.api
      .holonApiStreamingBatchTraceContextIsSampled(that: this);

  // HINT: Make it `#[frb(sync)]` to let it become the default constructor of Dart class.
  /// Create a new BatchTraceContext with all fields
  static Future<BatchTraceContext> newInstance({
    required String traceId,
    required String spanId,
    required int traceFlags,
    String? traceState,
  }) => RustLib.instance.api.holonApiStreamingBatchTraceContextNew(
    traceId: traceId,
    spanId: spanId,
  ...
  Future<void> operationId() => RustLib.instance.api
      .holonApiStreamingBatchTraceContextOperationId(that: this);
...
sealed class MapChange with _$MapChange {
  ...
  const factory MapChange.fieldsChanged({
    required String entityId,

    /// (field_name, old_value, new_value)
    required List<(String, Value, Value)> fields,
    required ChangeOrigin origin,
  }) = MapChange_FieldsChanged;
}
