...
class MockBackendService implements BackendService {
  ...
  Future<WidgetSpec> queryAndWatch({
    ...
    // Return the configured query result or default as WidgetSpec
    if (_queryResult != null) {
      final (renderSpec, data) = _queryResult!;
      return WidgetSpec(renderSpec: renderSpec, data: data, actions: const []);
    }
