...
pub use holon_core::{
    ...
    MoveOperations, OperationRegistry, OperationResult, RenameOperations, Result, TaskEntity,
...
pub trait OperationProvider: Send + Sync {
    ...
    ///
    /// Returns OperationResult containing FieldDeltas for change propagation and UndoAction for undo support.
...
where
    T: HasSchema + MaybeSendSync + 'static,
{
